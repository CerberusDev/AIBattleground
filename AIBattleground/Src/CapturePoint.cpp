...
Position(argPosition), HealStepInterval(sf::seconds(1.0f)), Team(argTeam), MaxHP(10000.0f), HP(MaxHP), HPPerSecond(MaxHP / 20.0f),
LowHPThreshold(MaxHP / 2.0f), VeryLowHPThreshold(MaxHP / 5.0f), Size(0.0f), bHasLowHP(false)
{
